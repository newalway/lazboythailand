...
class AdminHashtagType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('title', TextType::class, array(
                        ...
                        'required' => false,
                        'constraints' => array(
                            new NotBlank(array('message' => 'Please enter hashtag')))
        ));

        $builder->add('isHighlight', CheckboxType::class, array(
            'label'    => 'Top Furniture Categories',
            'required' => false,
        ));
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ProjectBundle\Entity\Hashtag'
        ));
    }
