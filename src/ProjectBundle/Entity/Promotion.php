...
class Promotion
{
	...
	* @ORM\ManyToMany(targetEntity="Showroom", inversedBy="promotions")
	* @ORM\JoinTable(name="promotions_showrooms")
	*/
	private $showrooms;
    ...
    */
    ...
    /**
    * @ORM\Column(name="status_custom_show",type="integer", options={"unsigned":true, "default":0})
    */
    private $statusCustomShow = 0;
    ...
    */
    public function removeShowrooms(Showroom $showroom)
    {
        ...
        $showroom->removePromotions($this);
    }
    ...
    */
    ...
    /**
     * Get the value of Status Submenu
     *
     * @return mixed
     */
    public function getStatusSubmenu()
    {
        return $this->statusSubmenu;
    }

    /**
     * Set the value of Status Submenu
     *
     * @param mixed statusSubmenu
     *
     * @return self
     */
    public function setStatusSubmenu($statusSubmenu)
    {
    ...
    /**
     * Get the value of Status Custom Show
     *
     * @return mixed
     */
    public function getStatusCustomShow()
    {
        return $this->statusCustomShow;
    }

    /**
     * Set the value of Status Custom Show
     *
     * @param mixed statusCustomShow
     * 
     * @return self
     */
    public function setStatusCustomShow($statusCustomShow)
    {
        $this->statusCustomShow = $statusCustomShow;
