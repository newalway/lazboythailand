...
class Sku
{
    ...
    /**
     * @ORM\Column(name="pattern_image_s", type="string", length=255, nullable = true)
     */
    private $patternImageS;

    /**
     * @ORM\Column(name="pattern_image_m", type="string", length=255, nullable = true)
     */
    private $patternImageM;

    /**
     * @ORM\Column(name="pattern_image_l", type="string", length=255, nullable = true)
     */
    private $patternImageL;
    ...
    {
        return $this->patternImageS;
    }

    /**
     * Set the value of Pattern Image
     *
     * @param mixed patternImageS
     *
     * @return self
     */
    public function setPatternImageS($patternImageS)
    {
     ...
     * @return mixed
     */
    public function getPatternImageM()
    {
        return $this->patternImageM;
    }

    /**
     * Set the value of Pattern Image
     *
     * @param mixed patternImageM
     *
     * @return self
     */
    public function setPatternImageM($patternImageM)
    {
        $this->patternImageM = $patternImageM;
     ...
     * @return mixed
     */
    public function getPatternImageL()
    {
        return $this->patternImageL;
    }

    /**
     * Set the value of Pattern Image
     *
     * @param mixed patternImageL
     *
     * @return self
     */
    public function setPatternImageL($patternImageL)
    {
        $this->patternImageL = $patternImageL;
