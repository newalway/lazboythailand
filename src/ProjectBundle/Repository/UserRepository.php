...
class UserRepository extends EntityRepository
{
	...
	public function getAllAdminUser()
	{
		...
		$qb->where($qb->expr()->orX(
			$qb->expr()->like('u.roles', ':user_roles'),
			$qb->expr()->like('u.roles', ':user_roles2'),
			$qb->expr()->like('u.roles', ':user_roles3')
		))
		->setParameter('user_roles',  '%ROLE_EDITOR%')
		->setParameter('user_roles2', '%ROLE_ADMIN%')
		->setParameter('user_roles3', '%ROLE_SUPER_ADMIN%')
		->orderBy('u.roles', 'ASC');
		return $qb;
