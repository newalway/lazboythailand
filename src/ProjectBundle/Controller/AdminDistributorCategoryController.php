...
use ProjectBundle\Form\Type\AdminDistributorCategoryType;
...
class AdminDistributorCategoryController extends Controller
{
    const ROUTER_INDEX = 'admin_distributor_category';
    const ROUTER_ADD = self::ROUTER_INDEX.'_new';
    const ROUTER_EDIT = self::ROUTER_INDEX.'_edit';
    const ROUTER_CONTROLLER = 'AdminDistributorCategory';

    protected function getQuerySearchData($arr_query_data)
    {
        $repository = $this->getDoctrine()->getRepository(DistributorCategory::class);
    ...
    */
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm(AdminDistributorCategoryType::class, new DistributorCategory());
    ...
    */
    public function createAction(Request $request)
    {
        ...
        $data = new DistributorCategory();
        $form = $this->createForm(AdminDistributorCategoryType::class, $data);
    ...
    */
    public function editAction(Request $request)
    {
        $util = $this->container->get('utilities');
        $util->setCkAuthorized();
        $data = $this->getDoctrine()->getRepository(DistributorCategory::class)->find($request->get('id'));
    ...
    */
    public function updateAction(Request $request)
    {
        ...
        $data = $em->getRepository(DistributorCategory::class)->find($request->get('id'));
        if (!$data) { throw $this->createNotFoundException('No data found'); }
    ...
    public function group_deleteAction(Request $request)
    {
        ...
        if ($data_ids) {
            ...
            foreach ($data_ids as $data_id) {
                $data = $em->getRepository(DistributorCategory::class)->find($data_id);
                if ($data) {
                    try {
                        $em->remove($data);
                        $em->flush();
