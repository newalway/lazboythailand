...
class AdminSkuController extends Controller
{
	...
	public function editAction(Request $request)
	{
		...
		$data = $this->getDoctrine()->getRepository(Sku::class)->getActiveWithVariantDataBySkuId($request->get('id'))->getQuery()->getOneOrNullResult();
		...
		$sku_values = $data->getSkuValues();
		$sku_variant_option = $product_util->getArrSkuVariantOptionFromSkuValues($sku_values);
