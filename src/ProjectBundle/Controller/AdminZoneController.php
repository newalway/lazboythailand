...
use ProjectBundle\Form\Type\AdminZoneType;
...
class AdminZoneController extends Controller
{
    ...
    */
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm(AdminZoneType::class, new Zone());
    ...
    */
    public function createAction(Request $request)
    {
        ...
        $data = new Zone();
        $form = $this->createForm(AdminZoneType::class, $data);
    ...
    */
    public function editAction(Request $request)
    {
        $util = $this->container->get('utilities');
        $util->setCkAuthorized();
        $data = $this->getDoctrine()->getRepository(Zone::class)->find($request->get('id'));
    ...
    */
    public function updateAction(Request $request)
    {
        ...
        $data = $em->getRepository(Zone::class)->find($request->get('id'));
        if (!$data) { throw $this->createNotFoundException('No data found'); }
    ...
    public function group_deleteAction(Request $request)
    {
        ...
        if ($data_ids) {
            ...
            foreach ($data_ids as $data_id) {
                $data = $em->getRepository(Zone::class)->find($data_id);
                if ($data) {
                    try {
                        $em->remove($data);
                        $em->flush();
